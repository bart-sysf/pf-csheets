...
<@loop from=0 to=spelllevelcount-1 ; spell , spell_has_next>
          ...
          <tr>
            <td class="border" style="font-size:7.25pt;">
              ...
              <i style="font-size:6.25pt;">${pcstring('SPELLMEM.${class}.0.${level}.${spell}.SCHOOL')}</i><br />
            ...
            <td class="border" style="font-size:6.25pt;">${pcstring('SPELLMEM.${class}.0.${level}.${spell}.EFFECT')}</td>
          </tr>
</@loop>
        </table>
      </div>
